...
# install gpio
sudo apt-get install raspi-gpio -y --assume-yes --allow-downgrades --allow-remove-essential --allow-change-held-packages --install-suggests --fix-broken --fix-missing --allow-remove-essential --allow-change-held-packages 

# install music player mpg123 (use: mpg123 song.mp3 to play a song)
sudo apt-get install mpg123 -y --assume-yes --allow-downgrades --allow-remove-essential --allow-change-held-packages --install-suggests --fix-broken --fix-missing --allow-remove-essential --allow-change-held-packages 

# install python smbus
sudo apt-get install python-smbus -y --assume-yes --allow-downgrades --allow-remove-essential --allow-change-held-packages --install-suggests --fix-broken --fix-missing --allow-remove-essential --allow-change-held-packages 

# install i2c tools
sudo apt-get install i2c-tools -y --assume-yes --allow-downgrades --allow-remove-essential --allow-change-held-packages --install-suggests --fix-broken --fix-missing --allow-remove-essential --allow-change-held-packages 
...
sudo apt-get install python3-pip -y --assume-yes --allow-downgrades --allow-remove-essential --allow-change-held-packages --install-suggests --fix-broken --fix-missing --allow-remove-essential --allow-change-held-packages 
...
sudo apt-get install python3-flask -y --assume-yes --allow-downgrades --allow-remove-essential --allow-change-held-packages --install-suggests --fix-broken --fix-missing --allow-remove-essential --allow-change-held-packages 


# install git
sudo apt-get install git  y --assume-yes --allow-downgrades --allow-remove-essential --allow-change-held-packages --install-suggests --fix-broken --fix-missing --allow-remove-essential --allow-change-held-packages 
